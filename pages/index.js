        ...
        return(
            <section className={`-mt-40 pb-12 sm:pb-20 text-white relative min-h-screen flex items-center`}>
                <div className={`relative z-10 max-w-screen-lg xl:max-w-screen-xl mx-auto`}>
                    <img src={`./assets/images/ecomi-art.png`}  width={`50%`} className={`absolute -right-28 -bottom-96 opacity-20`}/>
                    <section>
                    ...
                    <section className={`mt-16 mb-16`}>
                        <small className="text-sm font-semibold tracking-wide uppercase mb-2 text-gray-200 block">Did you know?</small>
                    ...
                    <section>
                        ...
                        <ul className={`my-5`}>
                            {exchanges && exchanges.map(exchange => <li key={exchange.id} className={`inline-block mr-2`}>
                                <a href={exchange.url} target={"_blank"} className="bg-pink-500 hover:bg-pink-700 text-white font-base py-2 px-4 rounded-full text-base">{exchange.title}</a>
                            </li>)}
                        </ul>
                    </section>
                ...
                <div className={`space-y-20 sm:space-y-32 md:space-y-40 lg:space-y-44 overflow-hidden`}>
                    <div className={`relative z-10 max-w-screen-lg xl:max-w-screen-xl mx-auto`}>
                        <div className={`mb-14 sm:mb-20 xl:mb-8 text-gray-200`}>
                            ...
                            <small className={`block mt-3 mb-8 sm:mb-10 text-gray-200`}><strong>TLDR:</strong> ECOMI is the company. VEVE is the application. OMI is the token.</small>
