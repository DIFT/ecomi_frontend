                            ...
                            <div className="grid grid-cols-6 gap-2 w-max mb-2">
                                ...
                                <div className={`text-center w-36 rounded-md overflow-hidden bg-gray-300  items-center justify-center flex`}>
                                    <div>
                                        ...
                                        <span className="block text-xs py-1 px-2 bg-gray-100 text-black text-left rounded-md">#86 Becky Cloonan Ba...</span>
                                ...
                                <div className={`text-center w-36 rounded-md overflow-hidden bg-gray-300  items-center justify-center flex`}>
                                    <div>
                                        ...
                                        <span className="block text-xs py-1 px-2 bg-gray-100 text-black text-left rounded-md">#86 Eduardo Risso Bat...</span>
