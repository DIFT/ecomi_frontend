...
function StoreRevenueLine({ lineData, name }) {
    ...
    useLayoutEffect(() => {
        ...
        series.dataFields.valueY = "totalStoreIncomeGenerated";
        series.dataFields.dateX = "date";
        series.tooltipText = "Revenue: {totalStoreIncomeGenerated}"
...
export default StoreRevenueLine