...
function NftSalesLine({ lineData, name }) {
    ...
    useLayoutEffect(() => {
        ...
        series.dataFields.valueY = "totalStoreNFTSalesCount";
        series.dataFields.dateX = "date";
        series.tooltipText = "No. of sales: {totalStoreNFTSalesCount}"
